...
int getIncreasingIntersectionArray(const int *a, const int a_len, const int *b, const int b_len, int *c, int *c_len) {
    *c_len = 0;
    int a_index = 0;
    int b_index = 0;
...
int main() {
    ...
    getIncreasingIntersectionArray(first_array, first_len, second_array, second_len, result_array, &result_len);
