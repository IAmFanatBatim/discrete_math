...
int isArraysEqual(const int *a, const int a_len, const int *b, const int b_len) {
    ...
    return is_a_part_of_b && a_len == b_len;
}
...
int main() {
    ...
    printf("%d", isArraysEqual(first_array, first_len, second_array, second_len));
}
