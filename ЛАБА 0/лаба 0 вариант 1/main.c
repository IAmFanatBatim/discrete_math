...
void getJoinArray(const int *a, const int a_len, const int *b, const int b_len, int *c, int *c_len) {
...
int main() {
    ...
    getJoinArray(first_array, first_len, second_array, second_len, result_array, &result_len);
